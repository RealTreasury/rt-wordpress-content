    ...
    <nav class="rt-nav-container">
        <div class="rt-nav-wrapper">
            ...
            <div class="rt-nav" id="mainNav">
                            ...
                            <div class="rt-main-menu">
                                ...
                                <div class="rt-main-menu-column rt-topics-column">
                                    ...
                                    <div class="rt-main-menu-links">
                                        <a href="#openPortalModal" class="rt-main-menu-link open-portal-modal">Treasury Tech Portal</a>
                            ...
                            <div class="rt-services-menu">
                                <div class="rt-services-grid">
                                    <div class="rt-service-item">
                                        ...
                                        <a href="#openPortalModal" class="rt-service-cta open-portal-modal">Request Access</a>
                                    </div>
                                    <div class="rt-service-item">
                ...
                <!-- View Portal -->
                <div class="rt-nav-item">
                    <a href="#openPortalModal" class="rt-cta-button tpa-btn-loading open-portal-modal" id="portalAccessBtn">VIEW PORTAL</a>
                </div>
            </div>
        </div>
    </nav>
